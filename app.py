...
def main():
    ...
    statement_of_purpose_score = st.number_input("Statement of Purpose Score", min_value=0.0, max_value=5.0, value=0.0)
    letter_of_recommendation_score = st.number_input("Letter of Recommendation Score", min_value=0.0, max_value=5.0, value=0.0)
